...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Fontis Remote".to_owned());
    ...
    pub static ref OVERWRITE_LOCAL_SETTINGS: RwLock<HashMap<String, String>> = RwLock::new(HashMap::from([("enable-check-update".to_owned(), "N".to_owned())]));
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.fontisberatung.ch"];
pub const RS_PUB_KEY: &str = "pOjg1dA09pHunbiZa9s9jjap3EnJDn1MbhTksVdDGPo=";
